...
bool psonce = false;
int Comp[9];
int psmaxval = 0;   //max værdi i forhold til diff
int psminval = 0;   //min værdi i arrayet til bestemmelse af diff
uint8_t psBPM = 0;  // beatsPerMinute
unsigned int pscurrentBeat;
...
#define LDRsensor 12     // Pin 12 is the pin used for LDR measurement
const uint8_t res = 12;  // 12 is the resolution of the ADC used
